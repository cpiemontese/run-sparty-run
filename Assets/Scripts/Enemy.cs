...
public class Enemy : MonoBehaviour
{
    ...
    [Range(0f, 10f)]
    public float enragedMoveSpeed = 6f; // enemy move speed when enraged
    ...
    [Tooltip("Time in secs to wait at each waypoint")]
    ...
    void Awake()
    {
        ...
        {
            Debug.LogWarning("SpriteRenderer component missing from this gameobject. Adding one.");
    ...
    void EnemyMovement()
    {
        ...
        if ((myWaypoints.Length != 0) && (_moving))
        {
            ...
            else
            {
                ...
                var speed = _enraged ? enragedMoveSpeed : moveSpeed;
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        if ((collision.tag == "Player") && !isStunned)
        {
            ...
            {
                var playerLookAtX = collision.transform.position.x - _transform.position.x;
